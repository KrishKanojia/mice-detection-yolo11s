...
class SAHIInference:
    ...
    def load_model(self, weights: str, device: str) -> None:
        ...
        yolo11_model_path = f"my_model_yolo11s_120_epochs/{weights}"
    ...
    def parse_opt() -> argparse.Namespace:
        ...
        parser.add_argument("--slice-width", default=640, type=int, help="Slice width for inference")
        parser.add_argument("--slice-height", default=480, type=int, help="Slice height for inference")
